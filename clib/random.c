...
// Random numbers in C
// 
// Ref: http://www.ciphersbyritter.com/NEWS4/RANDC.HTM
// 
...
int main(int argc, char** argv){
    ...
    // Load one argument to test RNG
    UL ran;
    sscanf(argv[1], "%lu", &ran);

    settable (835234, 93734, 535233, ran);
    for(int i=0;i<256;i++)  printf("%lu ", t[i]%1000);
    printf("\n");
    return 0;
}
